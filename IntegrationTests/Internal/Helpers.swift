...
public class Helpers: NSObject {
    ...
    static func createClientConfiguration() -> ClientConfiguration {
        ClientConfiguration(
                envKey: ProcessInfo.processInfo.environment["ENV_KEY"] ?? secretEnvKey,
                envSecret: ProcessInfo.processInfo.environment["ENV_SECRET"] ?? secretEnvSecret,
                test: true,
    ...
    @objc public static func initCreditCard() -> CreditCardInfo {
...
extension Helpers {
    ...
    public static func buildAddress() -> Address {
        let address = Address()
    ...
    public static func buildShippingAddress() -> Address {
        let address = Address()
